    ...
    <main className="bg-[#080808] pt-20">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="grid min-h-[64vh] w-full gap-6 overflow-hidden rounded-[2rem] border border-white/[0.08] bg-white/[0.02] p-6 md:grid-cols-[1.3fr_1fr] md:p-8 ">
            ...
            <div className="flex flex-col ">
              <p className="mb-5 text-[11px] uppercase tracking-[0.28em] text-white/28">
                Service Focus
              </p>
                ...
                {services.map((item, idx) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`group relative overflow-hidden rounded-2xl border p-4 md:p-5 transition-all duration-300 min-h-[150px] md:min-h-0 flex flex-col justify-between ${
                        active
                    ...
                    >
                      <div
                        className={`absolute left-0 top-0 h-full w-[3px] rounded-r transition-colors duration-300 ${
                          active
                            ? "bg-cyan-300"
                      ...
                      <div className="flex items-start justify-between gap-3 ">
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 ">
                          <span
                            className={`font-mono text-[11px] tracking-[0.22em] ${
                              active ? "text-cyan-200" : "text-white/28"
                            }`}
                          >
                            0{idx + 1}
                          </span>
                        ...
                        <div className="hidden md:block">
                          <motion.span
                            ...
                            className={`grid h-8 w-8 shrink-0 place-items-center rounded-full border text-sm transition-colors duration-300 ${
                              active
                      ...
                      <p
                        className={`mt-3 text-xs sm:text-sm leading-relaxed transition-colors duration-300 ${
                          active ? "text-white/75" : "text-white/42"
                        }`}
                      >
                        {item.note}
                      </p>
      ...
      <section className="relative overflow-hidden bg-[#06070b] px-6 py-28 text-white md:px-12">
        ...
        <div
          ...
          aria-hidden
        >
          <div className="absolute left-[-3%] top-8 text-[clamp(80px,16vw,220px)] font-semibold leading-none tracking-[-0.06em] text-white/[0.04]">
            PROCESS
          </div>
          <div className="absolute right-[-2%] top-[40%] text-[clamp(60px,13vw,180px)] font-semibold leading-none tracking-[-0.06em] text-cyan-300/[0.05]">
            SYSTEM
          </div>
          <div className="absolute bottom-[-3%] left-[10%] text-[clamp(80px,18vw,240px)] font-semibold leading-none tracking-[-0.06em] text-violet-300/[0.04]">
            FLOW
          </div>
        </div>
        <div
          className="pointer-events-none absolute -left-20 top-0 h-[500px] w-[500px] rounded-full bg-cyan-500/[0.07] blur-[140px]"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute -right-10 bottom-0 h-[500px] w-[500px] rounded-full bg-violet-500/[0.07] blur-[140px]"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_bottom,rgba(255,255,255,0.012)_1px,transparent_1px)] bg-[size:100%_80px]"
          aria-hidden
        />
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/45 md:text-lg">
              Every project moves through a refined engineering and design
              workflow — reducing chaos, improving clarity, and accelerating
              delivery.
            </p>
          </motion.div>
                ...
                <div className="space-y-8">
                  {processSteps.map((step, i) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`relative z-10 mt-1 h-9 w-9 shrink-0 rounded-full border transition-all duration-300 ${active ? "border-cyan-300 bg-cyan-300/20 shadow-[0_0_24px_rgba(34,211,238,0.30)]" : "border-white/12 bg-[#06070b]"}`}
                        >
                          <div
                            className={`absolute inset-[8px] rounded-full transition-colors ${active ? "bg-cyan-300" : "bg-white/18"}`}
                          />
                        </div>
                        <div>
                          <p
                            className={`font-mono text-[11px] tracking-[0.25em] transition-colors ${active ? "text-cyan-200" : "text-white/25"}`}
                          >
                            0{i + 1}
                          </p>
                          <h3
                            className={`mt-1.5 text-lg transition-colors ${active ? "text-white" : "text-white/45"}`}
                          >
                            {step.title}
                          </h3>
                          <p
                            className={`mt-1.5 max-w-[200px] text-sm leading-relaxed transition-colors ${active ? "text-white/58" : "text-white/28"}`}
                          >
                            {step.description}
                          </p>
                        </div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <h3 className="text-[clamp(2rem,4vw,3.5rem)] font-semibold leading-tight tracking-tight">
                      {processSteps[activeStep].title}
                    </h3>
                    <p className="mt-5 max-w-2xl text-base leading-relaxed text-white/52 md:text-lg">
                    ...
                    <div className="grid gap-3">
                      {processSteps[activeStep].bullets.map((bullet) => (
                        ...
                        >
                          ...
                          <p className="text-sm leading-relaxed text-white/58 md:text-[15px]">
                            {bullet}
                          </p>
                        </motion.div>
                      ))}
        ...
        >
          ...
          {(
            ...
            <div
              key={i}
              className="absolute"
              style={{ top: ic.top, left: ic.left, opacity: ic.op }}
            >
              <div
                style={{
                  animation: `rotate-slow ${ic.dur}s linear infinite`,
                  width: ic.size,
                  height: ic.size,
                }}
              >
                <StackIcon
                  name={ic.name}
                  variant="light"
                  style={{ width: ic.size, height: ic.size }}
                />
              </div>
            </div>
          ))}
          ...
          >
            <div>
              ...
              <p className="mt-5 max-w-xl text-base leading-relaxed text-white/45">
                Scalable products, modern experiences, and real business impact.
              </p>
            </div>
            <Link
              href="/portfolio"
      ...
      <section className="relative overflow-hidden bg-[#06070b] py-20 text-white">
        <div
          className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,#06070b_0%,transparent_12%,transparent_88%,#06070b_100%)] z-10"
          aria-hidden
        />
        ...
        <div className="flex overflow-hidden mb-4">
          ...
          >
            {[...TECH_ROW_1, ...TECH_ROW_1].map((name, i) => (
              <div
                key={i}
                className="flex h-12 w-12 shrink-0 items-center justify-center opacity-25 hover:opacity-60 transition-opacity"
              >
        ...
        <div className="flex overflow-hidden">
          ...
          >
            {[...TECH_ROW_2, ...TECH_ROW_2].map((name, i) => (
              <div
                key={i}
                className="flex h-12 w-12 shrink-0 items-center justify-center opacity-18 hover:opacity-55 transition-opacity"
              >
                <StackIcon name={name} style={{ width: 36, height: 36 }} />
              </div>
            ))}
      ...
      <section className="relative overflow-hidden bg-[#080808] px-6 py-28 text-white md:px-12">
        <div
          className="pointer-events-none absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-violet-600/[0.06] blur-[160px]"
          aria-hidden
        />
